...
cd /tmp
curl -O -L https://archives.streamsets.com/datacollector/1.1.1/tarball/streamsets-datacollector-1.1.1.tgz

# Extract tarball and cleanup
tar xzf /tmp/streamsets-datacollector-1.1.1.tgz -C /opt/
